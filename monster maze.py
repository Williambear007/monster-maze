...
def print_location():
    ...
    if location_name:
        if tuple(player_pos) == (1, 2) and quiz_completed:
            ...
            print("Wow a sign! It says West-fortune, East-sword and South-fight. Beware of monsters!")
            ...
            print("Congratulations! You beat the Monster Maze! Wow! :)")
...
print(f"Greetings {player_name}, welcome to the monster maze")
